                ...
                <div class="card custom-card h-100">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between pt-3">
                            ...
                            <div class="weather-detail-card flex-fill">
                                <span class="weather-detail-icon"><i
            ...
            <div class="col-lg-7 col-md-12">
                <div class="card custom-card h-100">
                    <div class="card-body">
                        ...
                        <div
                            style="height: 200px; background-color: #f8f9fa; border-radius: 10px; position: relative;">
                            <svg width="100%" height="100%" viewBox="0 0 500 200" preserveAspectRatio="none">
                                ...
                                <path
                                    d="M0 160 C 50 140, 100 120, 150 100 S 250 80, 300 90 T 400 120 L 500 130 V 200 H 0 Z"
                                    fill="url(#chartGradient)" stroke="#1d4ed8" stroke-width="2" />
                                <polyline
                                    points="0,160 50,140 100,120 150,100 200,80 250,80 300,90 350,110 400,120 450,125 500,130"
                                    fill="none" stroke="#1d4ed8" stroke-width="2" />
                            </svg>
                            <div class="d-flex justify-content-between px-2 pt-2"
                                style="position: absolute; bottom: 0; left: 0; right: 0; font-size: 0.75rem; color: #6c757d;">
